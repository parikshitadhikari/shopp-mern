...
const initialState = {
    userInfo: localStorage.getItem('userInfo') ? JSON.parse(localStorage.getItem('userInfo')) : null, //same concept as of cartSlice
}
...
const authSlice = createSlice({
    ...
    initialState,
    reducers: {
        setCredentials: (state, action) => { //set the user credentials to the local storage
